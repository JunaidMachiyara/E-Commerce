...
import { WOMEN_MEGA_MENU_DETAILS } from '../../constants';
import { CategoryColumn, PromotionContent, PageIdentifier } from '../../types'; // Import PageIdentifier

interface WomenCategoryNavigationProps {
  onNavigate: (page: PageIdentifier) => void; // Unified navigation handler
}

export const WomenCategoryNavigation: React.FC<WomenCategoryNavigationProps> = ({ onNavigate }) => {
  const { columns, promotion } = WOMEN_MEGA_MENU_DETAILS;
